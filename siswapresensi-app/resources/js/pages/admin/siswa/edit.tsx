...
import type { Kelas, OrangTua, Siswa } from '@/types/models';
...
export default function SiswaEdit({ siswa, kelasList, orangTuaList }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        nama_depan: siswa.nama_depan,
        nama_belakang: siswa.nama_belakang,
        nis: siswa.nis,
        kelas_id: siswa.kelas_id ? String(siswa.kelas_id) : '',
        orang_tua_id: siswa.orang_tua_id ? String(siswa.orang_tua_id) : '',
